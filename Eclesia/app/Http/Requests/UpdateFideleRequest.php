...
class UpdateFideleRequest extends FormRequest
{
    ...
    /**
     * Règles de validation conformes à la table `fideles` (id exclu de l'unicité).
     */
    public function rules(): array
    {
        return [
            'code_fidele' => ['required', 'string', 'max:15', 'unique:fideles,code_fidele,'.$this->route('fidele')->id],
    ...
    public function messages(): array
    {
        return [
            ...
            'code_fidele.unique' => 'Ce code fidèle est déjà utilisé.',
